...
public class common_Methods {
		...
		//get Text
			...
			//getAttribute
			public String getattribute(String identifier,String locator,String atrri_type)
			{
				String e=webElementId(identifier, locator).getAttribute(atrri_type);
				return e;
			}
		...
		public void SelectItemFromDroopdrown(String identifier,String locator,String val)
		{
			WebElement e=webElementId(identifier, locator);
			Se=new Select(e);
